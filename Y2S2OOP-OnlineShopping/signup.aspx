								...
								<div class="m-sm-4">
									<form runat="server">
										<div class="form-group">
											<label>Name</label>
                                            <asp:TextBox ID="txtUsername" runat="server" class="form-control form-control-lg" placeholder="Enter your name"></asp:TextBox>
										</div>
										<div class="form-group">
											<label>Email</label>
                                            <asp:TextBox ID="textEmail" runat="server" class="form-control form-control-lg" type="email" placeholder="Enter your email"></asp:TextBox>
										</div>
										<div class="form-group">
											<label>Password</label>
                                            <asp:TextBox ID="textPassword" runat="server" class="form-control form-control-lg" type="password" placeholder="Enter password"></asp:TextBox>
										</div>
                                        <div class="form-group">
											<label>Confirm your Password</label>
                                             <asp:TextBox ID="textConfirmPassword" runat="server" class="form-control form-control-lg" type="password" placeholder="Confirm your password"></asp:TextBox>
										</div>
										<div class="text-center mt-3">
                                            <asp:Button ID="Button1" runat="server" Text="Sign up" class="btn btn-lg btn-primary"/>
										</div>
									</form>
								</div>
							</div>
